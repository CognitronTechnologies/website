    ...
    <section className="relative mb-16">
      ...
      >
        <div className="flex gap-6 mb-4">
          <CpuChipIcon className="w-12 h-12 text-blue-400 animate-pulse" />
          <CubeTransparentIcon className="w-12 h-12 text-purple-400 animate-bounce" />
          <CloudIcon className="w-12 h-12 text-yellow-400 animate-spin-slow" />
        </div>
        <h1 className="text-5xl font-bold text-white mb-3 text-center">AI, Blockchain & Cloud for Your Future</h1>
